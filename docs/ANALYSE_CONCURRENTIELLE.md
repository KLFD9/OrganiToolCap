...
| Export CSV / annuaire | ✅ | ✅ | ❌ | Moteur conservé, interface différée |
...
| Export PowerPoint | ✅ | ✅ (premium) | ✅ | Moteur conservé, interface différée |
...
- **Import CSV contrôlé** (juillet 2026) : aligne le produit sur le cœur d'offre d'Organimi sans le SaaS, avec un garde-fou différenciant — analyse et aperçu locaux avant modification, signalement des cycles et responsables introuvables, choix explicite du rangement, résultat annulable et enregistré comme nouveau document.
...
- **Cadre de page + placement PDF maîtrisé** (juillet 2026) : la surface A4 standard (ou grand format avancé) est visible dans le canvas pendant la conception, avec zone utile et badge de lisibilité. Chaque page choisit entre conservation exacte des placements et ajustement automatique ; les nouveaux documents privilégient la fidélité, tandis que les anciens gardent leur rendu historique. Le contrôle pré-export détecte aussi les cartes partiellement coupées.
