...
- **Textes de page libres** : chaque page peut ajouter, remplacer, masquer ou reprendre le titre et le sous-titre du document depuis sa fiche. Sélectionner ensuite un titre, sous-titre ou pied de page affiche une barre flottante pour modifier le texte et sa mise en forme (gras, italique, couleur, réinitialisation). Le contenu et le style sont enregistrés dans le fichier et reproduits dans les exports PDF/PPTX.
